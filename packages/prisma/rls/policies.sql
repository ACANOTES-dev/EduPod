...
--   platform_sentry_issues   — platform-admin Sentry mirror; tenant_id is correlation only
...
-- =============================================================
-- Regulatory Safeguarding Registers (Phase 9)
-- =============================================================
-- Defined in: packages/prisma/migrations/20260424100000_add_safeguarding_regulatory_tables/migration.sql

-- dlp_register_entries (Designated Liaison Person appointments register)
...
-- staff_vetting_records (Garda vetting register with expiry tracking)
...
-- child_protection_reviews (annual CPP review log per Children First Act §11)
...
-- =============================================================
-- Defined in: packages/prisma/migrations/20260427120000_add_tenant_communication_configs_and_operational_tables/post_migrate.sql
...
-- tenant_whatsapp_configs (standard)
...
-- notification_suppression_list (standard)
...
-- whatsapp_service_windows (standard)
...
-- notification_webhook_events (standard)
