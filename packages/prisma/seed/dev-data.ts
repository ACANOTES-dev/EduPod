...
export const DEV_USERS: DevUser[] = [
  // Al Noor
  { email: 'owner@alnoor.test', first_name: 'Fatima', last_name: 'Al-Rashid', preferred_locale: 'ar', role_key: 'school_owner', tenant_slug: 'al-noor' },
  { email: 'admin@alnoor.test', first_name: 'Ahmed', last_name: 'Hassan', preferred_locale: 'ar', role_key: 'school_admin', tenant_slug: 'al-noor' },
  ...
  // Cedar
  { email: 'owner@cedar.test', first_name: 'Sarah', last_name: 'Mitchell', preferred_locale: 'en', role_key: 'school_owner', tenant_slug: 'cedar' },
  { email: 'admin@cedar.test', first_name: 'James', last_name: 'Cooper', preferred_locale: 'en', role_key: 'school_admin', tenant_slug: 'cedar' },
  ...
  // Nurul Huda
  { email: 'owner@nhqs.test', first_name: 'Yusuf', last_name: 'Rahman', preferred_locale: 'en', role_key: 'school_owner', tenant_slug: 'nhqs' },
  { email: 'admin@nhqs.test', first_name: 'Aisha', last_name: 'Patel', preferred_locale: 'en', role_key: 'school_admin', tenant_slug: 'nhqs' },
  ...
  // Midaad Ul Qalam
  { email: 'owner@mdad.test', first_name: 'Abdullah', last_name: 'Al-Farsi', preferred_locale: 'ar', role_key: 'school_owner', tenant_slug: 'mdad' },
  { email: 'admin@mdad.test', first_name: 'Maryam', last_name: 'Al-Sayed', preferred_locale: 'ar', role_key: 'school_admin', tenant_slug: 'mdad' },
