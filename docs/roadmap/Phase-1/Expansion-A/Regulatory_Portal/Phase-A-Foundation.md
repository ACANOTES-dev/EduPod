...
- Tusla absence mapping CRUD and DES subject mapping CRUD are included here (simple table operations). The complex business logic that _uses_ these mappings (SAR generation, DES file pipeline) is in Phases B and C respectively.
