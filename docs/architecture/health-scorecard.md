...
> Re-audit schedule: `docs/docs/architecture/re-audit-schedule.md`
...
- Feature flag guide: `docs/architecture/feature-flag-guide.md`
- Shadow-read pattern documented for safe migration rollouts
- Performance benchmarking guide: `docs/architecture/performance-benchmarking-guide.md`
...
- Bug-fix regression test convention: `docs/architecture/bug-fix-regression-convention.md`
