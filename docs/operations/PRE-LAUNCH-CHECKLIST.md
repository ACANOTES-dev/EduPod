...
| 20  | Lighthouse CI / Web Vitals budget enforcement                              | Report Cards bug log RC-C039          | 2026-04-16 | Perf spec defines per-route budgets (LCP, CLS, TBT, INP) but no CI gate enforces them. Add a Lighthouse CI workflow on main PRs with per-route budgets for `/report-cards`, `/report-comments`, dashboard, and inbox. Marked Won't Fix during the batch-6 bug sweep because it's infra work outside the report cards module scope. Ship before launch so regressions don't slip through.                                                                                                                                |
|     |                                                                            |                                       |            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
