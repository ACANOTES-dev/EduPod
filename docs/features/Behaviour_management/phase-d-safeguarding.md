...
describe('RLS — Safeguarding Tenant Isolation', () => {
  ...
  it('Tenant B cannot read Tenant A safeguarding_actions', async () => {
    /* same pattern */
  });

  it('Tenant B cannot read Tenant A safeguarding_break_glass_grants', async () => {
    /* same pattern */
  });

  it('Tenant B cannot access Tenant A safeguarding attachments', async () => {
    /* same pattern */
  });
});
```
