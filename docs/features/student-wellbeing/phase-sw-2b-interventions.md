...
export const interventionFilterSchema = z.object({
  ...
  status: z
    .enum(['active', 'achieved', 'partially_achieved', 'not_achieved', 'escalated', 'withdrawn'])
    .optional(),
...
// --- Intervention Actions ---
export const createInterventionActionSchema = z
  .object({
    description: z.string().min(1),
  ...
  .refine((data) => data.frequency !== 'once' || data.due_date !== undefined, {
