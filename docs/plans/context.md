...
| **CI/CD**             | GitHub Actions                     | Fast static/unit gates on every PR, selective visual/backend verification by changed area, full main-branch verification before deploy, manual full-suite runs, nightly restore drill |
