...
> Source of truth: [docs/audits/claude/risk-ledger_2026-04-01_02-39-37.md](../docs/audits/claude/risk-ledger_2026-04-01_02-39-37.md)
...
| `AUD-007` | Security/Tests  | High     | NOW      | Ram   | 2026-04-30 | Bring RLS integration tests into CI or replace with reliable smoke coverage.                                                | CI diff, green run, documented RLS coverage inventory.                                | ready_for_verification |
| `AUD-008` | Ops             | High     | NOW      | Ram   | 2026-04-30 | Replicate backups off the primary server and update restore docs.                                                           | Infra/config proof, restore drill notes, runbook update.                              | ready_for_verification |
...
| `AUD-025` | Security        | Low      | NEXT     | Ram   | 2026-05-31 | Consolidate the RLS policy catalogue into one canonical source.                                                             | Policy/doc diff, verification script or notes, architecture update if needed.         | ready_for_verification |
...
| `AUD-029` | Security        | Medium   | NEXT     | Ram   | 2026-05-31 | Retire the temporary Next.js audit exception by upgrading to a patched Next line and revalidating web smoke/build coverage. | Package diff, green `validate:fast`, green visual smoke, and deployment verification. | open                   |
