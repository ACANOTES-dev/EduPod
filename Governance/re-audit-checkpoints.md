...
> Audit method: rerun the static health audit workflow from `.claude/commands/audit2.md` or its active successor, then commit the dated artifacts under `Audit-Claude/`.

## Required checkpoints

| Checkpoint                 | Trigger                                                                                                   | Required before running                                                                                                                                        | Required outputs                                                                                                     |
| -------------------------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| Wave 1 static re-audit     | The Wave 1 exit gate in `Plans/HEALTH-RECOVERY-MASTERPLAN.md` is satisfied.                               | Updated backlog statuses, current scorecard, green `type-check`, `lint`, and `test` evidence.                                                                  | New dated audit artifacts, scorecard refresh, backlog refresh, follow-up risk deltas.                                |
