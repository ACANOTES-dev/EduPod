...
| `AUD-008` | Ops             | High     | NOW      | Ram   | 2026-04-30 | Replicate backups off the primary server and update restore docs.            | Infra/config proof, restore drill notes, runbook update.                      | in_progress            |
