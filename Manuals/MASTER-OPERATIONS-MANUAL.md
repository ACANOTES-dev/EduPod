...
### Test of everything
  ...
  grep DATABASE_URL /opt/edupod/app/.env | grep -o 'localhost:[0-9]*'
  echo ""
  echo "=== Tenant Count ==="
  ...
  _KEY_LOCAL)' /opt/edupod/app/.env | sed 's/=.*/=***SET***/'
  echo ""
  echo "=== .env symlink ==="
  ls -la /opt/edupod/app/apps/api/.env
  echo ""
