...
.btn-action { color: var(--primary-700); background: var(--primary-50); }
```
...
*This spec is the single source of truth for the EduPod UX redesign. When in doubt, refer to the vision document for the emotional intent, and this spec for the technical details.*
