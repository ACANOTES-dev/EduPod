...
- `architecture/refactoring-checklist.md` — references this convention in the pre-refactoring assessment
- `architecture/refactor-risk-matrix.md` — risk levels for changes; higher-risk areas need more coverage
- `architecture/characterization-testing-guide.md` — how to write tests for untested legacy code
