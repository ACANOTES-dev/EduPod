...
export class AiAuditService {
  ...
  async getLogsForSubject(tenantId: string, subjectType: string, subjectId: string): Promise<AiProcessingLog[]>
  async getLogsByService(tenantId: string, service: string, pagination: PaginationDto): Promise<PaginatedResult<AiProcessingLog>>
