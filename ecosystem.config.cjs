...
module.exports = {
  apps: [
    ...
    // upstream bugs are confirmed fixed.
    {
      ...
      instances: 1,
      autorestart: true,
      // Stage 9.5.2 §E: raised 2G → 4G → 7G. Tier-4 @ 600 s peaked at
      // 3.1 GB, tier-5 @ 300 s OOM'd at >4 GB. 7 GB gives headroom for
      // tier-5 at longer budgets and a reasonable entry point for tier-6
      // if a college customer materialises. Server has 12 GB free.
