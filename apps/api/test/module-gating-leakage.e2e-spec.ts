...
const PROBE_ENDPOINTS: Partial<Record<ModuleKey, ModuleGatingProbe['probes']>> = {
  ...
  leave: [
    { method: 'GET', path: '/api/v1/leave/requests' },
    { method: 'POST', path: '/api/v1/leave/requests', body: {} },
    { method: 'GET', path: '/api/v1/payroll/absence-periods?period=2026-05' },
  ],
  ...
  school_closures: [
    { method: 'GET', path: '/api/v1/school-closures' },
    { method: 'POST', path: '/api/v1/school-closures', body: {} },
  ],
