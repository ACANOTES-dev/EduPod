...
export class BehaviourStudentsService {
  ...
  async getStudentAnalytics(tenantId: string, studentId: string) {
    ...
    const [
      ...
      computeAnalyticsSummary(this.prisma, this.logger, tenantId, studentId),
      computeWeeklyTrend(this.prisma, tenantId, studentId),
      computeCategoryBreakdown(this.prisma, tenantId, studentId),
      computePeriodComparison(this.prisma, tenantId, studentId),
      computeSanctionHistory(this.prisma, tenantId, studentId),
      computeAttendanceCorrelation(this.prisma, tenantId, studentId),
    ]);
