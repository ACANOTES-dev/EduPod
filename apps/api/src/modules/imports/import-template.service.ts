...
const STUDENT_COLUMNS: TemplateColumn[] = [
  ...
  },
  {
    ...
    required: true,
    width: 16,
    comment: 'Format: YYYY-MM-DD. Student must be 3-25 years old',
    example: '2015-03-15',
  ...
  },
  {
    ...
    required: true,
    width: 10,
    comment: 'Select male or female',
    example: 'female',
    validation: listValidation(['male', 'female']),
  },
  {
    key: 'year_group',
    header: 'year_group *',
    required: true,
    width: 16,
    comment: 'Must match an existing year group',
    example: 'Year 1',
    validation: listValidation(['Year 1', 'Year 2', 'Year 3', 'Year 4', 'Year 5', 'Year 6']),
  },
  {
    key: 'class_name',
    header: 'class_name',
    required: false,
    width: 12,
    comment: 'e.g. Y1A, Y1B. Leave blank for auto-assignment',
    example: 'Y1A',
  },
  {
    key: 'nationality',
    ...
    required: false,
    width: 12,
    comment: '2-letter country code e.g. AE, GB, US',
    example: 'AE',
  },
  {
    key: 'city_of_birth',
    header: 'city_of_birth',
    required: false,
    width: 15,
    comment: 'City where student was born',
    example: 'Dubai',
  },
  {
    key: 'medical_notes',
    header: 'medical_notes',
    required: false,
    width: 25,
    comment: 'Free text medical information',
    example: '',
  },
  {
    key: 'allergies',
    ...
    required: false,
    width: 20,
    comment: 'e.g. peanuts, dairy. Leave blank if none',
    example: '',
  },
  {
    ...
    required: false,
    width: 20,
    comment: 'e.g. halal, vegetarian. Leave blank if none',
    example: 'halal',
  },
  {
    key: 'parent1_first_name',
    header: 'parent1_first_name *',
    required: true,
    width: 18,
    comment: 'Primary parent/guardian first name',
    example: 'Ahmed',
  },
  {
    key: 'parent1_last_name',
    header: 'parent1_last_name *',
    required: true,
    width: 18,
    comment: 'Primary parent/guardian last name',
    example: 'Al-Mansour',
  },
  {
    key: 'parent1_email',
    header: 'parent1_email *',
    required: true,
    width: 25,
  ...
  {
    key: 'parent1_phone',
    header: 'parent1_phone *',
    required: true,
    width: 18,
    comment: 'With country code e.g. +971501234567',
    example: '+971501234567',
  },
  {
    key: 'parent1_relationship',
    header: 'parent1_relationship *',
    required: true,
    width: 20,
    comment: 'Relationship to student',
    example: 'father',
    validation: listValidation(['father', 'mother', 'guardian', 'other']),
  },
  {
    key: 'parent2_first_name',
    header: 'parent2_first_name',
    required: false,
    width: 18,
    comment: 'Second parent (optional)',
    example: 'Fatima',
  },
  {
    key: 'parent2_last_name',
    header: 'parent2_last_name',
    required: false,
    width: 18,
    comment: '',
    example: 'Al-Mansour',
  ...
  {
    key: 'household_name',
    header: 'household_name',
    required: false,
    width: 22,
    comment: 'Auto-generated from parent surname if blank',
    example: '',
  },
  {
    key: 'address_line1',
...
const PARENT_COLUMNS: TemplateColumn[] = [
  ...
  },
  {
    ...
    required: false,
    width: 22,
    comment: 'Optional household name',
    example: 'The Al-Mansour Family',
  },
];
...
const STAFF_COLUMNS: TemplateColumn[] = [
  ...
  },
  {
    ...
    required: true,
    width: 18,
    comment: 'With country code e.g. +353851234567',
  ...
  },
  {
    ...
    required: true,
    width: 20,
    comment: 'Role name e.g. Teacher, Admin',
    example: 'Teacher',
  },
  // Employment Details
  {
  ...
  },
  {
    ...
    required: false,
    width: 18,
    comment: 'Default: active',
    example: 'active',
    validation: listValidation(['active', 'inactive']),
  },
  {
    key: 'employment_type',
    ...
    required: false,
    width: 18,
    comment: 'Default: full_time',
    example: 'full_time',
    validation: listValidation(['full_time', 'part_time', 'contract', 'substitute']),
  },
  // Bank Details
  {
    key: 'bank_name',
  ...
  },
  {
    ...
    required: false,
    width: 22,
    comment: 'Account number (encrypted at rest)',
    example: '12345678',
  },
  {
    key: 'bank_iban',
    ...
    required: false,
    width: 28,
    comment: 'IBAN (encrypted at rest)',
...
const FEES_COLUMNS: TemplateColumn[] = [
  {
    ...
    required: true,
    width: 22,
    comment: 'Must match an existing household',
    example: 'The Al-Mansour Family',
  },
  {
    key: 'fee_structure_name',
    header: 'fee_structure_name *',
    required: true,
    width: 25,
    comment: 'Must match an existing fee structure',
    example: 'Tuition Fee 2025-2026',
  },
  {
    key: 'amount',
    header: 'amount *',
...
const EXAM_RESULTS_COLUMNS: TemplateColumn[] = [
  {
    key: 'student_number',
    header: 'student_number *',
    required: true,
    width: 18,
    comment: 'Student enrolment number',
    example: 'MDAD-S-00001',
  },
  {
    key: 'student_name',
    header: 'student_name',
    required: false,
    width: 22,
    comment: 'For reference only, not imported',
    example: 'Aisha Al-Mansour',
  },
  {
    key: 'subject',
    header: 'subject *',
    required: true,
    width: 18,
    comment: 'Must match an existing subject',
    example: 'Mathematics',
  },
  {
    key: 'assessment_name',
    ...
    required: true,
    width: 22,
    comment: 'Must match an existing assessment',
...
const STAFF_COMPENSATION_COLUMNS: TemplateColumn[] = [
  {
    ...
    required: true,
    width: 16,
    comment: 'Staff identification number',
    example: 'STF-001',
  },
  {
    key: 'staff_name',
  ...
  },
  {
    ...
    header: 'compensation_type *',
    required: true,
    width: 20,
    comment: 'Type of compensation',
    example: 'salaried',
    validation: listValidation(['salaried', 'per_class', 'hourly']),
  },
  {
    key: 'amount',
    header: 'amount *',
  ...
  },
  {
    ...
    required: false,
    width: 14,
    comment: 'End date YYYY-MM-DD (optional)',
    example: '2026-08-31',
    numberFormat: 'yyyy-mm-dd',
  },
  {
...
export class ImportTemplateService {
  ...
  async generateTemplate(importType: ImportType): Promise<Buffer> {
    ...
    const studentExtraInstructions =
      importType === 'students'
        ? [
