...
export class ReportCardsQueriesService {
   ...
   *
   * @deprecated Report Cards Redesign (impl 06): prefer `getClassMatrix` for the
   *   class-first matrix view and `listReportCardLibrary` for the library view.
   *   This method remains in place until impl 12 flips the frontend and then
   *   deletes it alongside the old `/v1/report-cards/overview` route.
   */
  async gradeOverview(
    tenantId: string,
    params: {
