...
export function renderTranscriptAr(data: unknown, branding: PdfBranding): string {
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
              <thead>
                <tr style="background: #f3f4f6;">
                  <th style="padding: 6px 8px; text-align: right; font-weight: 600; border-bottom: 1px solid #d1d5db;">المادة</th>
                  <th style="padding: 6px 8px; text-align: center; font-weight: 600; width: 80px; border-bottom: 1px solid #d1d5db;">الدرجة (%)</th>
                  <th style="padding: 6px 8px; text-align: center; font-weight: 600; width: 80px; border-bottom: 1px solid #d1d5db;">التقدير</th>
                </tr>
              </thead>
              <tbody>
                ${period.subjects
                  ...
                  <tr>
                    ...
                    <td style="padding: 5px 8px; text-align: center; border-bottom: 1px solid #e5e7eb;" dir="ltr">${s.computed_value.toFixed(1)}%</td>
  ...
  <div style="padding: 0;">
    ...
    <div style="border-bottom: 3px solid ${primaryColor}; padding-bottom: 16px; margin-bottom: 24px;">
      <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
          <h1 style="font-size: 22px; font-weight: 700; color: ${primaryColor};">السجل الأكاديمي</h1>
    ...
    <table style="width: 100%; font-size: 13px; margin-bottom: 20px;">
      <tr>
        <td style="padding: 4px 0;"><strong>الطالب:</strong> ${escapeHtml(t.student.full_name)}</td>
        <td style="padding: 4px 0;"><strong>رقم الطالب:</strong> <span dir="ltr">${escapeHtml(t.student.student_number)}</span></td>
      </tr>
      <tr>
        <td style="padding: 4px 0;"><strong>المرحلة:</strong> ${escapeHtml(t.student.year_group)}</td>
        <td style="padding: 4px 0;"><strong>تاريخ الإصدار:</strong> <span dir="ltr">${new Date().toLocaleDateString('en-GB')}</span></td>
      </tr>
    </table>
    ...
    ${t.years.length === 0 ? '<p style="color: #6b7280; text-align: center; padding: 40px 0;">لا توجد سجلات أكاديمية متاحة.</p>' : ''}
  </div>
</body>
</html>`;
}
