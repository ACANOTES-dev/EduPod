...
import { AlertCircle, Info, RefreshCw, UserCircle2 } from 'lucide-react';
...
export function MyWorkloadSection() {
  ...
  const qualityLabel = summary?.timetable_quality_label ?? 'Moderate';
  ...
  return (
    <section id="my" className="scroll-mt-24 space-y-4">
      <SectionHeader
        icon={<UserCircle2 className="h-5 w-5 text-brand" aria-hidden="true" />}
        title={tStaff('sections.my.title')}
        description={tStaff('sections.my.description')}
      />
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-border bg-surface p-5">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <h3 className="text-sm font-semibold text-text-primary">{t('coverHistory')}</h3>
          ...
          {quality && (
            <div className="rounded-xl border border-border bg-surface p-5">
              <h3 className="text-sm font-semibold text-text-primary">{t('timetableBreakdown')}</h3>
              ...
              <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="rounded-lg border border-border/50 bg-surface-secondary p-4">
                  ...
                  <div className="mt-2 flex items-center gap-3 text-xs text-text-tertiary">
                    ...
                    <span>
                      {t('average')}:{' '}
                      <span dir="ltr">{quality.school_averages.consecutive_max}</span>
                    </span>
                  </div>
                </div>
          ...
          {summary.trend ? (
            <div className="rounded-xl border border-border bg-surface p-5">
              <h3 className="text-sm font-semibold text-text-primary">{t('trend')}</h3>
