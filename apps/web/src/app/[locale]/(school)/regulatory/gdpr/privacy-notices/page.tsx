...
export default function RegulatoryPrivacyNoticesPage() {
  ...
  const loadVersions = React.useCallback(
    async (preferredId?: string | null) => {
      try {
        ...
        console.error('[RegulatoryPrivacyNoticesPage.loadVersions]', err);
  ...
  const handleCreateDraft = React.useCallback(async () => {
    ...
    try {
      ...
      console.error('[RegulatoryPrivacyNoticesPage.handleCreateDraft]', err);
  ...
  const onSubmit = form.handleSubmit(async (values) => {
    ...
    try {
      ...
      console.error('[RegulatoryPrivacyNoticesPage.onSubmit]', err);
  ...
  const handlePublish = React.useCallback(async () => {
    ...
    try {
      ...
      console.error('[RegulatoryPrivacyNoticesPage.handlePublish]', err);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        back={{ href: `/${locale}/regulatory/gdpr`, label: tGdpr('backToGdpr') }}
        actions={
          <Button onClick={handleCreateDraft} disabled={creating} className="min-h-[44px]">
