...
export default function RegulatoryDsarPage() {
  const t = useTranslations('compliance');
  ...
  const fetchRequests = React.useCallback(
    async (p: number) => {
      ...
      try {
        ...
        console.error('[RegulatoryDsarPage.fetchRequests]', err);
      } finally {
        setIsLoading(false);
      }
    },
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          isOwner ? (
            <Button onClick={() => setNewDialogOpen(true)} className="min-h-[44px]">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  console.error('[RegulatoryDsarPage.confirmAgeGate]', err);
