      ...
      <div className="mt-6 space-y-4">
        ...
        <SectionCard title={t('sectionReportCards')} description={t('sectionReportCardsDesc')}>
          <SelectRow
            ...
            value={settings.reportCards.approvalConfigId ?? 'none'}
            options={[
              { value: 'none', label: t('rcDirectPublish') },
            ]}
            onChange={(v) =>
              updateSection('reportCards', { approvalConfigId: v === 'none' ? null : v })
            }
          />
          <BooleanRow
            label={t('rcAutoDelivery')}
            description={t('rcAutoDeliveryDesc')}
            value={settings.reportCards.autoDelivery}
            onChange={(v) => updateSection('reportCards', { autoDelivery: v })}
          />
          {settings.reportCards.autoDelivery && (
            <SelectRow
              label={t('rcDeliveryChannel')}
              value={settings.reportCards.deliveryChannel}
              options={[
                { value: 'email', label: t('channelEmail') },
                { value: 'whatsapp', label: t('channelWhatsApp') },
              ...
              onChange={(v) =>
                updateSection('reportCards', {
                  deliveryChannel: v as 'email' | 'whatsapp' | 'both',
                })
              }
            />
          )}
          <SubSectionCard title={t('rcComparativeIndicators')}>
            <BooleanRow
              ...
              value={settings.reportCards.showComparativeLabel}
              onChange={(v) => updateSection('reportCards', { showComparativeLabel: v })}
            />
            <BooleanRow
              label={t('rcShowPercentile')}
              description={t('rcShowPercentileDesc')}
              value={settings.reportCards.showPercentile}
              onChange={(v) => updateSection('reportCards', { showPercentile: v })}
            />
            <BooleanRow
              label={t('rcShowTopThreeRank')}
              description={t('rcShowTopThreeRankDesc')}
              value={settings.reportCards.showTopThreeRank}
              onChange={(v) => updateSection('reportCards', { showTopThreeRank: v })}
            />
          </SubSectionCard>
          <SubSectionCard title={t('rcParentAcknowledgment')}>
            <BooleanRow
              ...
              value={settings.reportCards.requireParentAcknowledgment}
              onChange={(v) =>
                updateSection('reportCards', { requireParentAcknowledgment: v })
              }
            />
            {settings.reportCards.requireParentAcknowledgment && (
              <NumberRow
                label={t('rcAcknowledgmentReminderDays')}
                description={t('rcAcknowledgmentReminderDaysDesc')}
                value={settings.reportCards.acknowledgmentReminderDays}
                onChange={(v) =>
                  updateSection('reportCards', { acknowledgmentReminderDays: v ?? 7 })
                }
                min={1}
              />
            )}
          ...
          <SubSectionCard title={t('rcAutoGenerate')}>
            <BooleanRow
              ...
              value={settings.reportCards.autoGenerateReportCards}
              onChange={(v) =>
                updateSection('reportCards', { autoGenerateReportCards: v })
              }
            />
            {settings.reportCards.autoGenerateReportCards && (
              <NumberRow
                label={t('rcAutoGenerateDaysAfterPeriodEnd')}
                description={t('rcAutoGenerateDaysAfterPeriodEndDesc')}
                value={settings.reportCards.autoGenerateDaysAfterPeriodEnd}
                onChange={(v) =>
                  updateSection('reportCards', { autoGenerateDaysAfterPeriodEnd: v ?? 1 })
                }
                min={0}
              />
            )}
