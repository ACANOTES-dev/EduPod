...
export default function CompensationListPage() {
  ...
  const fetchCompensation = React.useCallback(async () => {
    ...
    try {
      ...
      console.error('[fetchCompensation]', err);
    } finally {
      setIsLoading(false);
    }
  }, [page, typeFilter]);
  ...
  const handleViewHistory = async (staffProfileId: string) => {
    ...
    try {
      ...
      console.error('[handleViewHistory]', err);
    } finally {
  ...
  const handleAddAllowance = async () => {
    ...
    try {
      ...
      console.error('[handleAddAllowance]', err);
    }
  };
  ...
  const handleDeleteAllowance = async (id: string) => {
    try {
      ...
      console.error('[handleDeleteAllowance]', err);
    }
  };
  ...
  const handleAddDeduction = async () => {
    ...
    try {
      ...
      console.error('[handleAddDeduction]', err);
    }
  };
  ...
  const handleDeactivateDeduction = async (id: string) => {
    try {
      ...
      console.error('[handleDeactivateDeduction]', err);
    }
  };
