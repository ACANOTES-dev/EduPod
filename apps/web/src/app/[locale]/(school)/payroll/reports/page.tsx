...
export default function PayrollReportsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tab bar — horizontally scrollable on mobile, flex-1 on sm+ */}
        ...
        <div className="flex min-w-max gap-1 sm:min-w-0">
          {tabs.map((tab) => (
            <button
              ...
              className={`whitespace-nowrap rounded-lg px-3 py-2 text-sm font-medium transition-colors sm:flex-1 ${
                activeTab === tab.key
