...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        labelKey: 'navPayrollDashboard',
        href: '/payroll',
        icon: Wallet,
        descKey: 'descPayrollDashboard',
      },
      {
        labelKey: 'navPayrollRuns',
        href: '/payroll/runs',
        icon: Banknote,
        descKey: 'descPayrollRuns',
      },
      {
        labelKey: 'navPayrollCompensation',
        href: '/payroll/compensation',
        icon: UserCog,
        descKey: 'descPayrollCompensation',
      },
      {
        labelKey: 'navPayrollAttendance',
        href: '/payroll/staff-attendance',
        icon: Users,
        descKey: 'descPayrollAttendance',
      },
      {
        labelKey: 'navPayrollClassDelivery',
        href: '/payroll/class-delivery',
        icon: GraduationCap,
        descKey: 'descPayrollClassDelivery',
      },
      {
        labelKey: 'navPayrollReports',
        href: '/payroll/reports',
        icon: CalendarCheck,
        descKey: 'descPayrollReports',
      },
    ],
  },
];
