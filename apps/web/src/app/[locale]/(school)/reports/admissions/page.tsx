...
const YEAR_DEMAND = [
  ...
  { year: 'Year 8', apps: 18 },
  { year: 'Year 9', apps: 14 },
  { year: 'Year 10', apps: 11 },
  { year: 'Year 12', apps: 17 },
];
...
export default function AdmissionsAnalyticsPage() {
  ...
  const overallConversion =
    firstStage && lastStage ? Math.round((lastStage.count / firstStage.count) * 100) : 0;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <StatCard
          label={t('admissions.accepted')}
          value={FUNNEL_DATA.find((s) => s.stage === 'Accepted')?.count ?? 0}
        />
