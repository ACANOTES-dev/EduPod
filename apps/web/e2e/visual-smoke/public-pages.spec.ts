...
const PAGE_CASES: readonly VisualPageCase[] = [
  ...
  },
  {
    ...
    expectedDir: 'ltr',
    expectedLang: 'it',
    snapshot: 'login-it.png',
  },
  {
    path: '/it/login',
    expectedDir: 'ltr',
    expectedLang: 'it',
    snapshot: 'login-it-mobile.png',
    viewport: { height: 812, width: 375 },
  },
  {
    path: '/ro/login',
    expectedDir: 'ltr',
    expectedLang: 'ro',
    snapshot: 'login-ro.png',
  },
  {
    path: '/ro/login',
    expectedDir: 'ltr',
    expectedLang: 'ro',
    snapshot: 'login-ro-mobile.png',
    viewport: { height: 812, width: 375 },
  },
  {
    path: '/en/contact',
  ...
  },
  {
    ...
    expectedDir: 'ltr',
    expectedLang: 'it',
    snapshot: 'contact-it-mobile.png',
    viewport: { height: 900, width: 375 },
  },
  {
    path: '/ro/contact',
  ...
  },
  {
    ...
    expectedDir: 'ltr',
    expectedLang: 'ro',
    snapshot: 'contact-ro-mobile.png',
    viewport: { height: 900, width: 375 },
  },
] as const;
