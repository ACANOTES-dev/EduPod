...
| WB-C-19                                                        | **Verified code; migration pending approval** (model + migration + grant/review writes shipped; writes are best-effort until migration applied on prod)                                                         | `5687f1f5`, `1260e020` |
| WB-C-20                                                        | **Verified code; migration pending approval** (admin_repair_runs model + migration + recordRepairRun helper + GET /v1/behaviour/admin/repair-runs returned 200 live; best-effort until migration applied)       | `5687f1f5`, `1260e020` |
...
| WB-C-01..07                                                    | **Blocked — Group 3 pending** (security policy decisions; WB-C-07 pending user confirmation of 15-min access-token recommendation)                                                                              | —                      |
